...
// /* data queue from wifi modules*/
// QueueHandle_t wifi_status_queue = NULL;
// static void wifi_status_task(void *param) {
//   wifi_status_msg_t msg;
//   while (1) {
//     if (xQueueReceive(wifi_status_queue, &msg, portMAX_DELAY)) {
//       app_data.wifi_connected = (msg == WIFI_STATUS_CONNECTED);
...
//   // 1. Initialize LVGL and LCD panel
//   app_lvgl_init();

//   // 2. Create a task to handle wifi status updates
//   wifi_status_queue = xQueueCreate(5, sizeof(wifi_status_msg_t));
